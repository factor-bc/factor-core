...
var (
	...
	centralAddr = common.HexToAddress("b94f5374fce5edbc8e2a8697c15331677e6ebf0b")
	...
	simpleTrafficTx = NewTx(&TrafficTx{
		ChainID:        big.NewInt(1),
		Nonce:          3,
		Violator:       &testAddr,
		CentralAccount: &centralAddr,
		Penalty:        big.NewInt(10),
		Gas:            25000,
		GasPrice:       big.NewInt(1),
		Data:           common.FromHex("Hello Violator"),
	})
