...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "factor.ipc", false, filepath.Join(os.TempDir(), "factor.ipc")},
		{"data", "factor.ipc", false, "data/factor.ipc"},
		{"data", "./factor.ipc", false, "./factor.ipc"},
		{"data", "/factor.ipc", false, "/factor.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "factor.ipc", true, `\\.\pipe\factor.ipc`},
		{"data", "factor.ipc", true, `\\.\pipe\factor.ipc`},
		{"data", `\\.\pipe\factor.ipc`, true, `\\.\pipe\factor.ipc`},
	}
