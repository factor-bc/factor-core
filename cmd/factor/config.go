...
import (
	...
	"factor-mx/accounts/external"
	"factor-mx/accounts/keystore"
	"factor-mx/accounts/scwallet"
	"factor-mx/accounts/usbwallet"
	"factor-mx/cmd/utils"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "factor.ipc"
	return cfg
}

// makeConfigNode loads factor configuration and creates a blank node instance.
...
// makeFullNode loads factor configuration and creates the Ethereum backend.
