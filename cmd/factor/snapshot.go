...
import (
	...
	"factor-mx/core/state"
	"factor-mx/core/state/pruner"
	"factor-mx/core/state/snapshot"
	"factor-mx/core/types"
	"factor-mx/crypto"
	"factor-mx/log"
	"factor-mx/rlp"
	"factor-mx/trie"
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
factor snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
factor snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
factor snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
factor snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'factor dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'factor dump', but uses the snapshots
